...
export default function NewPtTrainingCardForm({ onClose, onNewTraining, ptId, clientId }: NewPtTrainingCardFormProps) {
    ...
    const handleSubmit = async () => {
        ...
        try {
            console.log('Dati inviati al server:', JSON.stringify(trainingData, null, 2));
            ...
            setErrorMessage(error instanceof Error ? error.message : 'Errore sconosciuto durante la creazione della scheda');
