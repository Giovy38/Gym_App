...
export default function PrimaryButton({ text, onClick, disabled }: GenericButtonType) {
    return (
        <div
            ...
            className={` ${disabled ? 'opacity-50' : 'opacity-100 cursor-pointer'} bg-primary-active font-bold rounded-md p-2 text-center hover:text-text-secondary ${disabled ? '' : 'hover:bg-primary-color'} `}>
